...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ticket_flow_edges'
        db.create_table(u'yats_ticket_flow_edges', (
            ...
            ('now', self.gf('django.db.models.fields.related.ForeignKey')(related_name='now', to=orm['yats.ticket_flow'])),
            ('next', self.gf('django.db.models.fields.related.ForeignKey')(related_name='next', to=orm['yats.ticket_flow'])),
        ))
        db.send_create_signal(u'yats', ['ticket_flow_edges'])

        # Adding model 'ticket_flow'
        db.create_table(u'yats_ticket_flow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active_record', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('c_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('c_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'yats', ['ticket_flow'])

        # Adding field 'tickets.state'
        db.add_column(u'yats_tickets', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yats.ticket_flow'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ticket_flow_edges'
        db.delete_table(u'yats_ticket_flow_edges')

        # Deleting model 'ticket_flow'
        db.delete_table(u'yats_ticket_flow')

        # Deleting field 'tickets.state'
        db.delete_column(u'yats_tickets', 'state_id')
    ...
    models = {
        ...
        u'yats.tickets': {
            ...
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['yats.ticket_flow']", 'null': 'True'}),
