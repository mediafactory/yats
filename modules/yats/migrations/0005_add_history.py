...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'tickets_history'
        db.create_table(u'yats_tickets_history', (
        ...
        db.send_create_signal(u'yats', ['tickets_history'])


    def backwards(self, orm):
        # Deleting model 'tickets_history'
        db.delete_table(u'yats_tickets_history')
