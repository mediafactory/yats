...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tickets_comments.action'
        db.add_column(u'yats_tickets_comments', 'action',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tickets_comments.action'
        db.delete_column(u'yats_tickets_comments', 'action')
