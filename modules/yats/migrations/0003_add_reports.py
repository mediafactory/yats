...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'tickets_reports'
        db.create_table(u'yats_tickets_reports', (
        ...
        db.send_create_signal(u'yats', ['tickets_reports'])

    def backwards(self, orm):
        # Deleting model 'tickets_participants'
        db.delete_table(u'yats_tickets_participants')

        # Deleting model 'tickets_reports'
        db.delete_table(u'yats_tickets_reports')

        # Deleting field 'tickets.closed'
        db.delete_column(u'yats_tickets', 'closed')
