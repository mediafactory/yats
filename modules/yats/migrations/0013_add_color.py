...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ticket_priority.color'
        db.add_column(u'yats_ticket_priority', 'color',
                      self.gf('django.db.models.fields.CharField')(default='transparent', max_length=255),
                      keep_default=False)


        # Changing field 'tickets.close_date'
        db.alter_column(u'yats_tickets', 'close_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'tickets.last_action_date'
        db.alter_column(u'yats_tickets', 'last_action_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'ticket_priority.color'
        db.delete_column(u'yats_ticket_priority', 'color')


        # Changing field 'tickets.close_date'
        db.alter_column(u'yats_tickets', 'close_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'tickets.last_action_date'
        db.alter_column(u'yats_tickets', 'last_action_date', self.gf('django.db.models.fields.DateField')(null=True))
