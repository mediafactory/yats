...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tickets.close_date'
        db.add_column(u'yats_tickets', 'close_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'tickets.last_action_date'
        db.add_column(u'yats_tickets', 'last_action_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tickets.close_date'
        db.delete_column(u'yats_tickets', 'close_date')

        # Deleting field 'tickets.last_action_date'
        db.delete_column(u'yats_tickets', 'last_action_date')
