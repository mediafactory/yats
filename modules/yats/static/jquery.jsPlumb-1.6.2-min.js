!function() {
    ...
    var a = {
        ...
        for (var d = [], e = f(b, c), h = c.length-1, i = 2 * h-1, j = g(e, i, d, 0)
            , k = a.subtract(b, c[0]), m = a.square(k), n = 0, o = 0;
        j > o;
        o++) {
    ...
    jsPlumbUtil = {
        ...
        logEnabled: !0,
        log: function() {
            if (jsPlumbUtil.logEnabled && "undefined" != typeof console)
                try {
    ...
    var l = function(a) {
        ...
        for (var d = c.split(/\s+/), e = n(a), f = e.split(/\s+/), g = 0; g < d.length; g++)
            if (b)
                -1 == jsPlumbUtil.indexOf(f, d[g]) && f.push(d[g]);
            else {
    ...
    var a = jsPlumbUtil, b = function(a, b, c) {
        ...
        if (this._jsPlumb = {
            ...
            return h
        }, b.events)for (var i in b.events)
            c.bind(i, b.events[i]);
        this.clone = function() {
            var a = {};
        ...
        this.bindListeners = function(a, b, c) {
            ...
            if (arguments.length > 1) {
                ...
                for (b = 1, c = arguments.length; c > b; b++)
                    this.attachListeners(a, arguments[b])
            }
        }
    };
    jsPlumbUtil.extend(j, jsPlumbUtil.EventGenerator, {
        ...
        applyType: function(a, b) {
            if (this.setPaintStyle(a.paintStyle, b), this.setHoverPaintStyle(a.hoverPaintStyle, b)
                , a.parameters)for (var c in a.parameters)
    ...
    var q = 0, r = function() {
        ...
        var n = null, o=!1, p = [], q = {}, s = {}, u = {}, v = {}, w = {}, x = {}, y=!1, z = [], A=!1, B = null, C = this.Defaults.Scope, D = null, E = 1, F = function() {
            ...
            if (!jsPlumbAdapter.headless&&!A) {
                ...
                if (e.anchorManager.redraw(g, b, d, null, f), h)
                    for (var k in h)
                        e.anchorManager.redraw(h[k].id, b, d, h[k].offset, f, !0)
            }
        }, J = function(b, c) {
            var d, f, g, h = null;
            if (a.isArray(b)) {
                ...
                for (var i = 0, j = b.length; j > i; i++)
                    d = e.getElementObject(b[i]), g = e.getDOMElement(d), f = e.getAttribute(g, "id"), h.push(c.apply(e, [g, f]))
            } else 
                d = e.getDOMElement(b), f = e.getId(d), h = c.apply(e, [d, f]);
            return h
        }, K = function(a) {
            return s[a]
        }, L = function(b, c, d) {
            ...
            var d = t.extend({}, b);
            if (c && t.extend(d, c), d.source && (d.source.endpoint ? d.sourceEndpoint = d.source : d.source = e.getDOMElement(d.source)
                ), d.target && (d.target.endpoint ? d.targetEndpoint = d.target : d.target = e.getDOMElement(d.target)), b.uuids && (d.sourceEndpoint = K(b.uuids[0]), d.targetEndpoint = K(b.uuids[1])), d.sourceEndpoint && d.sourceEndpoint.isFull())return a.log(e, "could not add connection; source endpoint is full"), void 0;
            if (d.targetEndpoint && d.targetEndpoint.isFull())
                return a.log(e, "could not add connection; target endpoint is full"), void 0;
            if (!d.type && d.sourceEndpoint && (d.type = d.sourceEndpoint.connectionType), d.sourceEndpoint && d.sourceEndpoint.connectorOverlays) {
                ...
                for (var f = 0, g = d.sourceEndpoint.connectorOverlays.length; g > f; f++)
            ...
            if (b = b || {}, a.suspendedEndpoint || p.push(a)
                , (null == a.suspendedEndpoint || d) && e.anchorManager.newConnection(a), I(a.source), !b.doNotFireConnectionEvent && b.fireEvent!==!1) {
                var f = {
                    connection: a,
                    source: a.source,
                    target: a.target,
        ...
        this.unregisterEndpoint = function(a) {
            ...
            if (0 !== arguments.length) {
                var a = e.Defaults.ConnectionType || e.getDefaultConnectionType(), b = arguments[0].constructor == a, c = 2 == arguments.length ? b ? arguments[1] || {}
                : arguments[0]: arguments[0], d = c.fireEvent!==!1, f = c.forceDetach, g = b ? arguments[0]: c.connection;
            ...
            var b = {
                ...
                if (null != a && null == b.connections[a.id] && (null != a._jsPlumb && a.setHover(!1), b.connections[a.id] = a, b.connectionCount++, d))
                    for (var c = 0; c < a.endpoints.length; c++)
                        a.endpoints[c]._deleteOnDetach && g(a.endpoints[c])
            }, g = function(a) {
            ...
            if ("object" == typeof a && a.length)
                for (c = 0, d = a.length; d > c; c++)
                    f = e.getDOMElement(a[c]), f && L(f, !0, b);
            else if (a._nodes)
                for (c = 0, d = a._nodes.length; d > c; c++)
                    f = e.getDOMElement(a._nodes[c]), f && L(f, !0, b);
            else 
                f = e.getDOMElement(a), f && L(f, !0, b);
            return e
        };
        ...
        this.select = function(a) {
            ...
            for (var h in q) {
                ...
                if (i || j || l)
                    a: for (var n = 0, o = q[h].length; o > n; n++) {
                    var p = q[h][n];
                    if (gb(f, p.scope, !0)) {
        ...
        this.init = function() {
            ...
            for (var f = [], g = 0, h = b.length; h > g; g++)
                "string" == typeof b[g] ? f.push(t.Anchors[b[g]]({
                    elementId: c,
                    jsPlumbInstance: d
        ...
        var tb = function(a, b, c, d, e) {
            for (var f = a.target || a.srcElement, g=!1, h = d.getSelector(b, c)
                , i = 0;
            i < h.length;
            i++)if (h[i] == f) {
                g=!0;
        ...
        this.makeTarget = function(c, d, f) {
            ...
            var h = g.scope || e.Defaults.Scope, i=!(g.deleteEndpointsOnDetach===!1), l = g.maxConnections||-1, m = g.onMaxConnections, n = function(c) {
                ...
                var o = function() {
                    ...
                    var a = this.getDropEvent(arguments), c = this.select({
                        target: e
                    }).length, h = this.getDOMElement(this.getDragObject(arguments)), j = this.getAttribute(h, "dragId"), k = this.getAttribute(h, "originalScope"), l = w[j], n = l.endpoints[0].isFloating() ? 0: 1, o = l.endpoints[0], p = (g.endpoint ? t.extend({}, g.endpoint) : {}, this.targetEndpointDefinitions[e]);
                    if (!p.enabled || p.maxConnections > 0 && c >= p.maxConnections)
                        return m && m({
                            element: d.el,
                            connection: l
                        }, a), !1;
                    if (o.anchor.locked=!1, k && this.setDragScope(h, k)
                        , null == l.suspendedEndpoint&&!l.pending)return !1;
                    ...
                    if (q) {
                        ...
                        l.suspendedEndpoint && (l.isReattach() ? (l.setHover(!1), l.floatingAnchorIndex = null, l.suspendedEndpoint.addConnection(l), this.repaint(o.elementId)) : o.detach(l, !1, !0, !0, a))
                }.bind(this), p = t.dragEvents.drop;
                n.scope = n.scope || h, n[p] = a.wrap(n[p], o), this.initDroppable(this.getElementObject(d.el), n, !0)
            }.bind(this);
            c = H(c);
            for (var o = c.length && c.constructor != String ? c : [c], p = 0, q = o.length; q > p; p++)
                n(o[p]);
            return this
            ...
            var h = g.maxConnections||-1, j = g.onMaxConnections, l = function(c) {
                ...
                var w = function(a) {
                    ...
                    if (d = this.getId(this.getDOMElement(f)), c.enabled) {
                        ...
                        if (c.maxConnections >= 0 && o >= c.maxConnections)
                            return j && j({
                                element: f,
                                maxConnections: h
                            }, a), !1;
            ...
            c = H(c);
            for (var n = c.length && c.constructor != String ? c : [c], o = 0, p = n.length; p > o; o++)
                l(k(n[o]));
            return this
            ...
            var c = function(a) {
                ...
                if (h)
                    for (d = 0, f = h.length; f > d; d++)
                        e.deleteEndpoint(h[d]);
                if (delete q[g.id], b && g.el && 3 != g.el.nodeType && 8 != g.el.nodeType)
                    for (d = 0, f = g.el.childNodes.length; f > d; d++)
                        c(g.el.childNodes[d])
            };
            return c(a), this
        ...
        this.registerListener = function(a, b, c) {
            ...
            for (var g = 0, h = q[b].length; h > g; g++)
                q[b][g].setElementId(b), q[b][g].setReferenceElement(a);
    ...
    jsPlumb.Endpoint = function(g) {
        ...
        this.initDraggable = function() {
            if (!t && jsPlumb.isDragSupported(this.element)) {
                var d = {
                    id: null,
                    element: null
                }, e = null, f=!1, m = null, n = a(d, h), q = function() {
                    e = this.connectorSelector();
                    var a=!0;
                    if (this.isEnabled() || (a=!1), null != e || this.isSource || (a=!1)
                        , this.isSource && this.isFull()&&!this.dragAllowedWhenFull && (a=!1), null == e || e.isDetachable() || (a=!1), a===!1)return h.stopDrag && h.stopDrag(this.canvas), n.stopDrag(), !1;
                    for (var q = 0; q < this.connections.length; q++)
                        this.connections[q].setHover(!1);
                    ...
                    if (jsPlumbAdapter.setPosition(d.element, s), this.parentAnchor && (this.anchor = h.makeAnchor(this.parentAnchor, this.elementId, h)
                        ), h.setAttribute(this.canvas, "dragId", d.id), h.setAttribute(this.canvas, "elId", this.elementId), this._jsPlumb.floatingEndpoint = c(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, d.element, h, l), this.canvas.style.visibility = "hidden", null == e)this.anchor.locked=!0, this.setHover(!1, !1), e = k({
                        sourceEndpoint: this,
            ...
            if ((this.isTarget || b) && jsPlumb.isDropSupported(this.element)) {
                ...
                var f = jsPlumb.dragEvents.drop, i = jsPlumb.dragEvents.over, k = jsPlumb.dragEvents.out, l = function() {
                    ...
                    if (null != f) {
                        ...
                        if (g)
                            return f._forceReattach=!0, void 0;
                        ...
                        if (this.isFull() && this.fire("maxConnections", {
                            ...
                            var l = function() {
                                ...
                                if (f.suspendedEndpoint) {
                                    ...
                                    b.draggable && jsPlumb.initDraggable(this.element, dragOptions, !0, h);
        ...
        setVisible: function(a, b, c) {
            if (this._jsPlumb.visible = a, this.canvas && (this.canvas.style.display = a ? "block" : "none")
                , this[a ? "showOverlays": "hideOverlays"](), !b)for (var d = 0; d < this.connections.length; d++)
    ...
    jsPlumb.Connection = function(a) {
        ...
        if (d.updateOffset({
            ...
            elId : this.targetId, timestamp : g
        })
            , !d.isSuspendDrawing()) {
    ...
    jsPlumb.AnchorManager = function(a) {
        ...
        var u = function(b, c, d, e, f, g, h, i, j, k, l, m) {
            ...
            if (u) {
                ...
                if (-1 != v) {
                    ...
                    for (var w = 0; w < u.length; w++)
                        jsPlumbUtil.addWithFunction(l, u[w][1], function(a) {
            ...
            for (w = 0; w < t.length; w++)
                1 == a.idx && t[w][3] === g&&-1 == o && (o = w), jsPlumbUtil.addWithFunction(l, t[w][1], function(a) {
        ...
        var v = function(a) {
            ...
            }, k = c ? i : j, l = c ? j : i, m = a.cssClass || "", n = 0; n < b.length; n++)
                g[b[n]]=!0;
        ...
        this.computeMaxSize = function() {
            ...
            if (a.pointAlongPathFrom) {
                if (b.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                    ...
                    if (h = a.pointOnPath(this.loc), i = a.pointAlongPathFrom(this.loc, - this.length)
                        , j = c.pointOnLine(h, i, this.length), -1 == e) {
                            var o = j;
                            j = h, h = o
                        }
                } else if (0 === this.loc) {
                    if (j = a.pointOnPath(this.loc), i = a.pointAlongPathFrom(this.loc, this.length)
                        , h = c.pointOnLine(j, i, this.length), -1 == e) {
                            var p = j;
                            j = h, h = p
                        }
                } else 
    ...
    jsPlumbUtil.extend(f, [jsPlumb.DOMElementComponent, d], {
        ...
        if (jsPlumb.Overlays.Custom.call(this, b), this.type = "Label", this.label = a.label || "", this.labelText = null, this.labelStyle) {
            ...
            if (this.labelStyle.font = this.labelStyle.font || "12px sans-serif", c.style.font = this.labelStyle.font, c.style.color = this.labelStyle.color || "black", this.labelStyle.fillStyle && (c.style.background = this.labelStyle.fillStyle)
    ...
    var a = function(a, b, c, d) {
        ...
        this._compute = function(c, k) {
            ...
            if (Math.min(k.sourcePos[0], k.targetPos[0]), Math.min(k.sourcePos[1], k.targetPos[1])
    ...
    var a = {
        ...
        for (var b = 0; b < a.childNodes.length; b++)(a.childNodes[b].tagName == f || a.childNodes[b].tagName == d || a.childNodes[b].tagName == e) 
        ...
        if (e.setAttribute(g, f.fillStyle ? jsPlumbUtil.convertStyle(f.fillStyle, !0) : l), e.setAttribute(i, f.strokeStyle ? jsPlumbUtil.convertStyle(f.strokeStyle, !0) 
            : l), f.gradient ? t(d, e, f, h, m) : (s(d), e.setAttribute(k, "")), f.lineWidth && e.setAttribute(j, f.lineWidth), f[c] && f[n]&&!f[b]) {
    ...
    jsPlumbUtil.extend(w, jsPlumb.jsPlumbUIComponent, {
        ...
        c.renderer.paint = function(c, d, e) {
            ...
            if (e.xmin < 0 && (h[0] =- e.xmin), e.ymin < 0 && (h[1] =- e.ymin)
                , f.length > 0) {
    ...
    var f = 1e3, g = function(a, b) {
        ...
        if (b.dashstyle)
            ...
            for (var j =- 1 == b["stroke-dasharray"].indexOf(",") ? " " : ",", l = b["stroke-dasharray"].split(j)
                , m = "", n = 0;
                n < l.length;
                n++)m += Math.floor(l[n] / b.lineWidth) + j;
                null == c.strokeNode ? c.strokeNode = h("stroke", [0, 0, 0, 0], {
                    dashstyle: m
        ...
        this.paint = function(d) {
            if (null !== d) {
                ...
                for (var e = this.getSegments(), j = {
                    path: ""
                }, k = [this.x, this.y, this.w, this.h], m = 0; m < e.length; m++)
                    j.path += jsPlumb.Segments.vml.SegmentRenderer.getPath(e[m]), j.path += " ";
                if (d.outlineColor) {
