# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-07-13 18:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_estimated_time', models.FloatField(blank=True, null=True)),
                ('billing_time_taken', models.FloatField(blank=True, null=True)),
                ('billing_type', models.CharField(blank=True, choices=[(b'service', b'service'), (b'development', b'development')], max_length=255, null=True)),
